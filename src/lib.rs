// src/lib.rs
/*
 * Core library for CryptoScanner
 */
...
#[derive(Debug)]
pub struct CryptoScannerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoScannerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoScanner processing");
    
    let mut processor = CryptoScannerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoScannerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoScannerProcessor::new(false);
